...
def get_argparser():
    ...
    parser.add_argument('--log_path', default='/home/nikola/master-thesis/models/pretrained/', type=str)
    parser.add_argument('--save_path', default='/home/nikola/master-thesis/models/pretrained/', type=str)
