...
class FSCD147_Points(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ret = {
            ...
            "points": all_points, # 点
            "labels": labels,
            "anchor_points": anchor_points, # 由示例框计算得到中心点，再得到锚点
            "orig_size": orig_size,
        }
        return ret
...
class FSCD147_Test(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ret = {
            ...
            "image_id": coco_im_id,
            "image": image,
            "points": scaled_points, # 由框中心点坐标转换得
            "boxes": scaled_boxes, # 框
            "orig_size": orig_size,
            "exemplar_boxes": scaled_exemplar_boxes, # 示例框
            "labels": labels, # 
            "ori_points": box_centers, # 框中心点坐标（由box得）
        }
        return ret
