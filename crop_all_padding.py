...
target_folder = "/opt/data/private/data/blueberry2_crop_padding_32"


image_source_folder = os.path.join(source_folder, "images_ssim_beforecrop")
image_target_folder = os.path.join(target_folder, "images_ssim_beforecrop")
