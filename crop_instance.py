...
target_folder = "/opt/data/private/data/blueberry_crop_loca"
...
#             # 在bbox中添加示例框坐标
#             # 裁剪bbox            
#             cropped_bbox = torch.tensor(xyxy_boxes) - torch.as_tensor([[j * crop_size[1], i * crop_size[0], j * crop_size[1], i * crop_size[0]]])
#             # 限制横坐标在 0 到 512 之间
